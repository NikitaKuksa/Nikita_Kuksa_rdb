...
| 5 | `LEFT JO`LEFT JOIN`tensätze ohne Treffer rechts zeigen. | |
| 6 | `HAVIN`HAVING` vor dem ``GROUP BY` | |
...
**Arbeitsgrundlage:**
- SQL-Struktur`foodtrucknetz_struktur_2025.sql`l`
- SQL-Daten: `foodtrucknetz_dat`foodtrucknetz_daten_2025.sql`afik: `foodtrucknetz_2025.png`

![EERM Te`foodtrucknetz_2025.png`text](./foodtrucknetz_2025.png)
...
- SQL-Lösungen Teil C: al`.mwb`i oder Text
