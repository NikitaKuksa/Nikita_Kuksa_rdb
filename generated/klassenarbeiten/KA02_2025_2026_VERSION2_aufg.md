...
| 5`LEFT JOIN`IN` zeigt immer nur Datensätze mit Partner an. | |
|`HAVING`VING` filtert gruppierte Ergebnisse. | |
...
**Arbeitsgrundlage:**
- SQL-`coworkingcampus_struktur_2025.sql`_2025.sql`
- SQL-Daten: `coworkingca`coworkingcampus_daten_2025.sql`renzgrafik: `coworkingcampus_2025.png`

![E`coworkingcampus_2025.png`-Kontext](./coworkingcampus_2025.png)
...
- SQL-Lösungen Teil C: `.mwb`tei oder Text
